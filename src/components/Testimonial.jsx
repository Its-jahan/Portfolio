...
export default function Testimonial() {
  return (
    <section className="flex w-full flex-col items-center justify-center gap-[15px]">
      <Reveal><blockquote className="max-w-[690px] text-center text-[28px] leading-[33px] tracking-[-0.84px] text-black">
        "Working with Ali felt like having a seasoned design partner{' '}
