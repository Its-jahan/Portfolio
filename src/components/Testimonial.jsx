  ...
  return (
    <section className="flex w-full flex-col items-center justify-center gap-[15px]">
      ...
      <Reveal delay={120}><figure className="flex items-center gap-3">
        <img src={avatar} alt="Nic Campanile" className="size-[33px] rounded-full object-cover" />
        <figcaption className="flex flex-col gap-1.5">
          <p className="text-[14px] leading-[15.68px] tracking-[-0.14px] text-black">Nic Campanile</p>
